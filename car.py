...
# Setting parameters for Q-learn AI: 5 inputs, 3 outputs and gamma = 0.9
brain = Dqn(5, 3, 0.9)
...
class Car(Widget):
    ...
    def move(self, rotation):
        ...
        if self.sensor1_x > longueur - 10 or self.sensor1_x < 10 or self.sensor1_y > largeur - 10\
                or self.sensor1_y < 10:
            self.signal1 = 1.
        if self.sensor2_x > longueur - 10 or self.sensor2_x < 10 or self.sensor2_y > largeur - 10\
                or self.sensor2_y < 10:
            self.signal2 = 1.
        if self.sensor3_x > longueur - 10 or self.sensor3_x < 10 or self.sensor3_y > largeur - 10\
